...
int main(int argc, string argv[])
{
    ...
    // verifica se ha algum caractere que não é numérico
    for (int i = 0, t = strlen(argv[1]); i < t; i++) // i percorre todos os caracteres da array;
    {
        if (isdigit(argv[1][i]) == false) // se houver algum caractere que não é um digito
        {
            printf("Use: ./code key\n");
            return 1;
        }
